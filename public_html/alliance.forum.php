...
<?
	...
	switch($error) {
		...
		break;
		case 103:
		$msg = 'You\'re not the commander or subcommander for your alliance.';
		break;
		case 104:
...
<table border="0" cellpadding="0" cellspacing="0" width="800">
	<tr>
		...
		<td width="180">Alliance forum</td>
				...
				<tr>
					<td valign="top">
						<table border="0" width="800">
							...
							<?
							$sql_threads = "SELECT $table[allianceforum_threads].id, $table[allianceforum_threads].alliance_id, $table[allianceforum_threads].subject, $table[allianceforum_threads].starter,
												$table[allianceforum_posts].date, $table[allianceforum_posts].poster_id
											FROM $table[allianceforum_threads]
											INNER JOIN $table[allianceforum_posts] ON 
												$table[allianceforum_threads].id = $table[allianceforum_posts].thread_id
												AND $table[allianceforum_threads].date = $table[allianceforum_posts].date
											WHERE 
												$table[allianceforum_threads].alliance_id = '$playerdata[alliance_id]'
											GROUP BY $table[allianceforum_posts].thread_id
											ORDER BY $table[allianceforum_posts].date DESC
							";
							...
							<tr>
								...
								<td align="center"><input type="submit" name="delthread" value="del"></td>
							</tr>
							</form>
							<?
								}
							...
							?>
							<tr>
								<td colspan="5" align="center">There are no threads in this alliance forum.</td>
							</tr>
							<?
							}
							?>
	...
	<tr>
		...
		<td width="696" height="100%" valign="top" colspan="2">
			<table border="0" cellpadding="0" cellspacing="0" width="800">
				<tr>
					<td valign="top">
						<form method="POST" action="main.php?mod=<?=$mod;?>&act=forum&do=newthread" name="newthread">
						<table border="0" width="800">
							<tr>
