...
while ($rec_gettop = mysql_fetch_array($res_gettop)) {
	...
	$planetname = addslashes($rec_gettop['planetname']);
	...
	$sql_newtop = "INSERT INTO $table[universe] (`id`, `rulername`, `planetname`, `tag`, `score`, `asteroids`) VALUES ('', '$rulername', '$planetname', '$tag', '$score', '$asteroids')";
...
for ($j = 0; $j < $max_count; $j++) {
	...
	$sql_newgalaxytop = "INSERT INTO $table[universe_galaxy] (`galaxy_id`, `total_members`, `score`, `asteroids`) 
						VALUES ('$galaxy_id', '$total_members', '$score', '$asteroids')";
